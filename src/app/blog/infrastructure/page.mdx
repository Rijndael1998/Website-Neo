...
### Issues
 - When you use [XCP-ng](https://xcp-ng.org/) with the default [Xen Orchestra](https://xen-orchestra.com/#!/xoa), you will not be able to perform updates.
  <LazyImage src={"/blog/infrastructure/server.png"} aspectRatio={736 / 315}/> The very simple solution to this is to use the [community version](https://github.com/Jarli01/xenorchestra_installer). It's good enough to just update but I'm still unsure if I want to use this as a daily driver just yet.
...
![5df8c68b69c864f8a4a583148a93e751.png](:/lan.png)
