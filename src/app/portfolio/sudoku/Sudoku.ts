...
export const easyGrid = get3_2d(rawEasyGrid.map(nullZero2d));
...
export const easyGridDone = get3_2d(backtracking(Duplicate2DArray(rawEasyGrid), 0) as Array<Array<number>>);
...
export const hardGrid = get3_2d(rawHardGrid.map(nullZero2d));

export const hardGridDone = get3_2d(backtracking(Duplicate2DArray(rawHardGrid), 0) as Array<Array<number>>);
